...
class Teams extends Component {
    ...
    handleMedChange = event => {
      ...
      onSubmit = () => {
        ...
        console.log(this.state.teamResidents)
        axios
          .post(`${URL_TEAMS}/`, {
    ...
    render() {
        const {allResidents, teams, teamName, teamMedicalCenter, loading} = this.state
            ...
            <Fragment>
                ...
                >
                    ...
                    <Form.Item label="Residentes">
                        <Select mode="multiple" onChange={this.onSelectChange} placeholder="Selecionar residente">
